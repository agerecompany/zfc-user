...
class ChangePassword extends Form {
	...
	public function __construct($dbAdapter)
	{
		...
		$inputFilter->add($factory->createInput(array(
			...
			'validators' => array(
				array(
					'name' => '\Agere\Agere\Validator\Db\OldPassword',
					'options' => array(
						'table' => 'users',
						'field' => 'password',
						'fields' => ['id' => '?'],
						'adapter' => $dbAdapter,
						'methodHashPassword' => '\Agere\Users\Service\UsersService::getHashPassword',
					)
				),
			),
		)));
		...
		$inputFilter->add($factory->createInput(array(
			...
			'validators' => array(
				array(
					'name' => '\Agere\Agere\Validator\Password\Simple',
					'options' => array(
						'min' => 6,
					)
				)
